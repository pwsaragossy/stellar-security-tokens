...
The interface below uses the Rust [soroban-sdk](/docs/tools/sdks/contract-sdks.md) to declare a trait that complies with the [SEP-41](https://github.com/stellar/stellar-protocol/blob/master/ecosystem/sep-0041.md) token interface.
...
More details on Authorization can be found [here](/docs/learn/fundamentals/contract-development/authorization.md).
