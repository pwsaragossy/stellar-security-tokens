...
1. [Smart contracts](/docs/build/smart-contracts.md)
2. [Applications](/docs/build/apps.md)
3. [How-to guides](/docs/build/guides.md)
...
> **Tip:** While defining the rules and logic of the contract, developers must be security conscious to avoid vulnerabilities such as integer overflows, access control flaws, and other exploits that could compromise the integrity and functionality of the smart contract.
...
> **Note:** You can create applications on Stellar without using smart contracts, as demonstrated in the [Wallet SDK tutorial](/docs/build/apps/wallet/overview.md) or the [JS SDK Payment Application tutorial](/docs/build/apps/example-application-tutorial/overview.md).
...
> **Note:** How-to guides assume that the user has some experience and knowledge with building on Stellar and are not typically for beginners.