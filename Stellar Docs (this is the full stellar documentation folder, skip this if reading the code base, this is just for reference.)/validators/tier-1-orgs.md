...
> **Note:** Be sure to properly add your own validators to your validators' quorum sets. As a Tier 1 organization with three validators and history archives, SDF recommends declaring your organization [`HIGH` quality](/docs/validators/admin-guide/configuring.md) in your quorum set configuration. Declaring your organization at a lower quality level [may limit its participation in consensus](/docs/validators/admin-guide/configuring.md).
...
We recommend using Prometheus to scrape and store your stellar-core metrics, and Grafana to render that data for human consumption. You can find step-by-step instructions for setting up monitoring and alerts in [Monitoring and Diagnostics](/docs/validators/admin-guide/monitoring.md), along with links to Grafana dashboards weve created to make things easier.
