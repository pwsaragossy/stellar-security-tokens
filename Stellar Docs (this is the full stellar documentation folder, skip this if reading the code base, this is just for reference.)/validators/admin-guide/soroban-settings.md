...
Soroban has a large collection of settings stored on-ledger that can be modified through a validator vote. Here you can find out how to propose a new settings upgrade as well as how to examine a proposed upgrade. You can also look at the [Commands page](/docs/validators/admin-guide/commands.md) for more details on the stellar-core commands used below.

## Propose a Settings Upgrade[](#propose-a-settings-upgrade "Direct link to Propose a Settings Upgrade")

This section will describe how to propose a settings upgrade, but take a look at the [Upgrading the Network page](/docs/validators/admin-guide/network-upgrades.md) for more information on how the settings upgrade mechanism works internally.

> **Info:** If you are being asked to vote for an upgrade, please move on to the [Examine a Proposed Upgrade](#examine-a-proposed-upgrade) section for details on how to accomplish that.
...
> **Info:** `stellar` CLI can be installed using brew or cargo:
...
You can also download a [precompiled binary](https://github.com/stellar/stellar-cli/releases/latest) of the latest release for your system from GitHub.

### 2. Generate Settings Upgrade Transactions[](#2-generate-settings-upgrade-transactions "Direct link to 2. Generate Settings Upgrade Transactions")
...
### 3. Submit Settings Upgrade Transactions[](#3-submit-settings-upgrade-transactions "Direct link to 3. Submit Settings Upgrade Transactions")
...
> **Note:** If you didn't provide the `--signtxs` parameter to the `get-settings-upgrade-txs` command, don't forget to sign them before submitting to the network.
...
### 4. Verify Proposed Upgrades[](#4-verify-proposed-upgrades "Direct link to 4. Verify Proposed Upgrades")
...
### 5. Schedule the Upgrades[](#5-schedule-the-upgrades "Direct link to 5. Schedule the Upgrades")
...
### 6. Update Stellar Expert[](#6-update-stellar-expert "Direct link to 6. Update Stellar Expert")

One of the most-used methods of "watching" an upgrade take place for the network's Soroban settings is the [Protocol History page](https://stellar.expert/explorer/pubnet/protocol-history) on [stellar.expert](https://stellar.expert).

In order to make sure that page gets updated with the proposed upgrades, please fill out a PR against [this repository](https://github.com/stellar-expert/staged-soroban-upgrades).
...
* Resources are too low. You'll need to increase the hardcoded resources in [`SettingsUpgradeUtils.cpp`](https://github.com/stellar/stellar-core/blob/master/src/main/SettingsUpgradeUtils.cpp).
* Fee or refundable fee is too low. You'll need to increase them in [`SettingsUpgradeUtils.cpp`](https://github.com/stellar/stellar-core/blob/master/src/main/SettingsUpgradeUtils.cpp).
...
## Examine a Proposed Upgrade[](#examine-a-proposed-upgrade "Direct link to Examine a Proposed Upgrade")
...
## Examine Current Settings[](#examine-current-settings "Direct link to Examine Current Settings")
