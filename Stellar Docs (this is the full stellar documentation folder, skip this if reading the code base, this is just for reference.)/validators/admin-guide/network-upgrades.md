...
A node can be configured to vote for upgrades using the `upgrades` endpoint . See [Commands](/docs/validators/admin-guide/commands.md) for more information.
...
## Important Notes on Network Wide Settings[](#important-notes-on-network-wide-settings "Direct link to Important Notes on Network Wide Settings")
...
## Upgrading Soroban Settings[](#upgrading-soroban-settings "Direct link to Upgrading Soroban Settings")
...
We have much more detail on the [next page](/docs/validators/admin-guide/soroban-settings.md) about *how* to craft an upgrade proposal for these settings. Be sure to read and understand that.

## Example Upgrade Command[](#example-upgrade-command "Direct link to Example Upgrade Command")
