...
If you want to run a [Full Validator](/docs/validators.md), you need to set up your node to publish a history archive. You can host an archive using a blob store such as Amazon's S3 or Digital Ocean's spaces, or you can simply serve a local archive directly via an HTTP server such as Nginx or Apache. If you're setting up a [Basic Validator](/docs/validators.md), you can skip this section. No matter what kind of node you're planning to run, make sure to set it up to `get` history, which is covered in [Environment Preparation](/docs/validators/admin-guide/environment-preparation.md).

## Caching and History Archives[](#caching-and-history-archives "Direct link to Caching and History Archives")
...
## Local History Archive Using nginx[](#local-history-archive-using-nginx "Direct link to Local History Archive Using nginx")
...
## Amazon S3 History Archive[](#amazon-s3-history-archive "Direct link to Amazon S3 History Archive")
...
## Backfilling a History Archive[](#backfilling-a-history-archive "Direct link to Backfilling a History Archive")
...
## Complete History Archive[](#complete-history-archive "Direct link to Complete History Archive")
