...
## Advanced Solidity Concepts[](#advanced-solidity-concepts "Direct link to Advanced Solidity Concepts")
...
## Advanced Rust Concepts[](#advanced-rust-concepts "Direct link to Advanced Rust Concepts")

### Crates[](#crates "Direct link to Crates")
...
For more details on how to use the `alloc` crate, including a hands-on practical exercise, visit the [alloc example contract](/docs/build/smart-contracts/example-contracts/alloc.md).

#### Inheriting Functionality from Other Crates[](#inheriting-functionality-from-other-crates "Direct link to Inheriting Functionality from Other Crates")
...
#### Inheriting Functionality using `contractimport!`[](#inheriting-functionality-using-contractimport "Direct link to inheriting-functionality-using-contractimport")
...
#### A Note on Inheritance and Composability[](#a-note-on-inheritance-and-composability "Direct link to A Note on Inheritance and Composability")
...
There are many types of smart contract interfaces, and each has a specific purpose. One example of an interface built with Soroban is the [Token Interface](/docs/tokens/token-interface.md). This interface ensures that tokens deployed on Soroban are interoperable with Soroban's built-in tokens (such as the Stellar Asset Contract). The Token Interface consists of three compatibility requirements:

* `function interface`
* `authorization`
* `events`

For more information on smart contract interfaces built with Soroban, including the Token Interface, visit the [tokens section](/docs/tokens.md) of the documentation.

## Writing Safe and Efficient Rust Code for Smart Contracts[](#writing-safe-and-efficient-rust-code-for-smart-contracts "Direct link to Writing Safe and Efficient Rust Code for Smart Contracts")
...
## Solidity to Soroban: Common Concepts and Best Practices[](#solidity-to-soroban-common-concepts-and-best-practices "Direct link to Solidity to Soroban: Common Concepts and Best Practices")
...
### Message Properties[](#message-properties "Direct link to Message Properties")
...
For instance, you would use `env.storage().persistent().get(key)` to access a `persistent` target value from the contract's [storage](https://docs.rs/soroban-sdk/latest/soroban_sdk/struct.Env.html). Read more about the different storage types [here](/docs/learn/fundamentals/contract-development/storage/persisting-data.md).
...
#### Solidity[](#solidity-1 "Direct link to Solidity")
...
#### Soroban[](#soroban-1 "Direct link to Soroban")
...
### Address-Related Functionality[](#address-related-functionality "Direct link to Address-Related Functionality")

Both Soroban and Solidity provide provide a number of functions for working with addresses. These functions include:

#### Solidity[](#solidity-2 "Direct link to Solidity")
...
#### Soroban[](#soroban-2 "Direct link to Soroban")
...
#### Why Soroban Differs[](#why-soroban-differs "Direct link to Why Soroban Differs")
...
### Function Visibility Specifiers[](#function-visibility-specifiers "Direct link to Function Visibility Specifiers")
...
#### Solidity[](#solidity-3 "Direct link to Solidity")
...
#### Soroban[](#soroban-3 "Direct link to Soroban")
...
### Time-Based Variables[](#time-based-variables "Direct link to Time-Based Variables")
...
#### Solidity[](#solidity-4 "Direct link to Solidity")
...
#### Soroban[](#soroban-4 "Direct link to Soroban")
...
#### Solidity[](#solidity-5 "Direct link to Solidity")
...
#### Soroban[](#soroban-5 "Direct link to Soroban")
...
Soroban authorization provides Contract-level Authorization, Account Abstraction Functionality, and more advanced Authorization checks. To learn more about these advantages, visit the [Authorization section](/docs/learn/fundamentals/contract-development/authorization.md) of the documentation.
