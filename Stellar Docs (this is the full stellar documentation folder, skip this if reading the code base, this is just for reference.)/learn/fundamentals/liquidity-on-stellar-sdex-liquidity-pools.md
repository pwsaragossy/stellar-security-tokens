...
> **Note:** This section is scoped specifically to liquidity regarding the AMM and SDEX built into the Stellar protocol and does not include information regarding smart contracts.
...
In this section, we will talk about the SDEX and liquidity pools. To learn about how these work together to execute transactions, see our [Path Payments Guide](/docs/build/guides/transactions/path-payments.md).

## SDEX[](#sdex "Direct link to SDEX")

The Stellar network acts as a decentralized distributed exchange that allows users to trade and convert assets with the [Manage Buy Offer](/docs/learn/fundamentals/transactions/list-of-operations.md) and [Manage Sell Offer](/docs/learn/fundamentals/transactions/list-of-operations.md) operations. The Stellar ledger stores both the balances held by user accounts and orders that user accounts make to buy or sell assets.

### Order books[](#order-books "Direct link to Order books")
...
### Price and operations[](#price-and-operations "Direct link to Price and operations")
...
To learn more about transaction fees, see our section on [Fees section](/docs/learn/fundamentals/fees-resource-limits-metering.md).

## Liquidity pools[](#liquidity-pools "Direct link to Liquidity pools")
...
### Automated Market Makers (AMMs)[](#automated-market-makers-amms "Direct link to Automated Market Makers (AMMs)")
...
#### AMM pricing[](#amm-pricing "Direct link to AMM pricing")
...
### Liquidity pool participation[](#liquidity-pool-participation "Direct link to Liquidity pool participation")
...
#### Participation: Creation[](#participation-creation "Direct link to Participation: Creation")
...
#### Participation: Deposits[](#participation-deposits "Direct link to Participation: Deposits")
...
#### Participation: Withdrawals[](#participation-withdrawals "Direct link to Participation: Withdrawals")
...
#### Watching Liquidity Pool Activity[](#watching-liquidity-pool-activity "Direct link to Watching Liquidity Pool Activity")
