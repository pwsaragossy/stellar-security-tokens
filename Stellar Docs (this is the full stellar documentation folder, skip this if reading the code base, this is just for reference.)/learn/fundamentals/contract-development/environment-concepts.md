...
## Host and Guest[](#host-and-guest "Direct link to Host and Guest")
...
## WebAssembly (Wasm)[](#webassembly-wasm "Direct link to WebAssembly (Wasm)")
...
When developing and testing contract code off-chain, it is possible to compile contract code to native machine code rather than Wasm bytecode, and to [run tests and debug contracts](/docs/learn/fundamentals/contract-development/errors-and-debugging/debugging.md) against a local copy of the host environment by linking directly to it, rather than executing within a VM. This configuration runs much faster and provides much better debugging information, but is only possible locally, off-chain. On-chain deployed contracts are always Wasm.
...
## Host objects and functions[](#host-objects-and-functions "Direct link to Host objects and functions")
...
## Values and types[](#values-and-types "Direct link to Values and types")
...
![](/assets/images/environment-concepts-70bcdfa34521ab4f7d43e4b2f3207aca.png)