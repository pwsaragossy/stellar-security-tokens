...
## Local-testing mode[](#local-testing-mode "Direct link to Local-testing mode")
...
## Wasm mode[](#wasm-mode "Direct link to Wasm mode")
...
* The Wasm VM *could* provide them but doing so would violate constraints of the [contract Rust dialect](/docs/learn/fundamentals/contract-development/rust-dialect.md).
...
* A general logging system that allows contracts to log values of the [shared host/guest "value" type](/docs/learn/fundamentals/contract-development/environment-concepts.md), even in production.
