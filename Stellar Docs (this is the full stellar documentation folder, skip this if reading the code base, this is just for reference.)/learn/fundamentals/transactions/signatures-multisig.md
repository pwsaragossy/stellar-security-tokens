...
> **Note:** This section details signing non-smart contract transactions. For auth related to smart contract transactions, see [authorization](/docs/learn/fundamentals/contract-development/authorization.md).)
...
Each operation falls under a specific threshold category: low, medium, or high with a number level between 0-255 (to read more about this see our section on [Operations and Transactions](/docs/learn/fundamentals/transactions/operations-and-transactions.md)). This threshold determines what signature weight is needed to authorize an operation.

To view each operations threshold, see our [List of Operations section](/docs/learn/fundamentals/transactions/list-of-operations.md).
...
### Alternate signature types[](#alternate-signature-types "Direct link to Alternate signature types")
...
#### Pre-authorized Transaction[](#pre-authorized-transaction "Direct link to Pre-authorized Transaction")
...
#### Hash(x)[](#hashx "Direct link to Hash(x)")

> **Note:** Hash(x) signing is a different concept from transaction hashes. Transaction hashes are unique identifiers generated by applying a cryptographic hash function to the data of a transaction in a blockchain. They serve as a digital fingerprint and allow users to verify and reference transactions on the network. Hash(x) is a signature type.
...
### Example 1: Anchors[](#example-1-anchors "Direct link to Example 1: Anchors")
...
### Example 2: Joint accounts[](#example-2-joint-accounts "Direct link to Example 2: Joint accounts")
...
### Example 3: Expense accounts[](#example-3-expense-accounts "Direct link to Example 3: Expense accounts")
...
### Example 4: Company accounts[](#example-4-company-accounts "Direct link to Example 4: Company accounts")
