...
Learn more about transactions and operations in our [Operations and Transactions section](/docs/learn/fundamentals/transactions/operations-and-transactions.md).
...
> **Note:** All these operations have an optional source account parameter. If the source account parameter is omitted, the source account of the transaction is considered as the source account of the operation.
...
| `PAYMENT_NO_DESTINATION` | -5 | The receiving account does not exist. Note that this error will **not** be returned if the receiving account is the issuer of `asset` (i.e, when the asset is being *burned*). |
| `PAYMENT_NO_TRUST` | -6 | The receiver does not trust the issuer of the asset being sent. For more information, see the [Assets section](/docs/learn/fundamentals/stellar-data-structures/assets.md). |
...
## Path payment strict send[](#path-payment-strict-send "Direct link to Path payment strict send")
...
Learn more about path payments: [Path Payments Guide](/docs/build/guides/transactions/path-payments.md)
...
| `PATH_PAYMENT_STRICT_SEND_NO_TRUST` | -6 | The destination account does not trust the issuer of the asset being sent. For more, see the [Assets section](/docs/learn/fundamentals/stellar-data-structures/assets.md). |
...
## Path payment strict receive[](#path-payment-strict-receive "Direct link to Path payment strict receive")
...
| `PATH_PAYMENT_STRICT_RECEIVE_NO_TRUST` | -6 | The destination account does not trust the issuer of the asset being sent. For more, see the [Assets section](/docs/learn/fundamentals/stellar-data-structures/assets.md). |
...
## Manage buy offer[](#manage-buy-offer "Direct link to Manage buy offer")

Creates, updates, or deletes an offer to buy a specific amount of an asset for another

Learn more about passive sell offers: [Liquidity on Stellar: SDEX and Liquidity Pools](/docs/learn/fundamentals/liquidity-on-stellar-sdex-liquidity-pools.md)
...
## Manage sell offer[](#manage-sell-offer "Direct link to Manage sell offer")
...
## Create passive sell offer[](#create-passive-sell-offer "Direct link to Create passive sell offer")
...
## Set options[](#set-options "Direct link to Set options")

Set options for an account such as flags, inflation destination, signers, home domain, and master key weight

Learn more about flags: [Flags Section](/docs/tokens/control-asset-access.md)  
...
Learn more about signers operations and key weight: [Signature and Multisignature Section](/docs/learn/fundamentals/transactions/signatures-multisig.md)
...
| Clear flags | integer | Indicates which [account](/docs/learn/fundamentals/stellar-data-structures/accounts.md) flags to clear. These account-level flags are primarily used by asset issuers. For details about the flags, please refer to the [Asset Design Considerations page](/docs/tokens/control-asset-access.md). The bit mask integer subtracts from the existing flags of the account. This allows for setting specific bits without knowledge of existing flags. |
| Set flags | integer | Indicates which [account](/docs/learn/fundamentals/stellar-data-structures/accounts.md) flags to set. These account-level flags are primarily used by asset issuers. For details about the flags, please refer to the [Asset Design Considerations page](/docs/tokens/control-asset-access.md) The bit mask integer adds onto the existing flags of the account. This allows for setting specific bits without knowledge of existing flags. |
...
| Low threshold | integer | A number from 0-255 (inclusive) representing the threshold this account sets on all operations it performs that have [a low threshold](/docs/learn/fundamentals/transactions/signatures-multisig.md). |
| Medium threshold | integer | A number from 0-255 (inclusive) representing the threshold this account sets on all operations it performs that have [a medium threshold](/docs/learn/fundamentals/transactions/signatures-multisig.md). |
| High threshold | integer | A number from 0-255 (inclusive) representing the threshold this account sets on all operations it performs that have [a high threshold](/docs/learn/fundamentals/transactions/signatures-multisig.md). |
| Home domain | string | Sets the home domain of an account. See [Federation](/docs/learn/glossary.md). |
...
## Change trust[](#change-trust "Direct link to Change trust")

Creates, updates, or deletes a trustline

Learn more about trustlines: [Trustlines section](/docs/learn/fundamentals/stellar-data-structures/accounts.md)
...
## Allow trust[](#allow-trust "Direct link to Allow trust")

Updates the authorized flag of an existing trustline. This operation can only be performed by the asset issuer

> **Warning:** This operation is deprecated as of Protocol 17- prefer [*SetTrustlineFlags*](#set-trustline-flags) operation instead.
...
## Account merge[](#account-merge "Direct link to Account merge")
...
Learn more about entries and subentries: [Accounts section](/docs/learn/fundamentals/stellar-data-structures/accounts.md)
...
## Bump sequence[](#bump-sequence "Direct link to Bump sequence")
...
## Create claimable balance[](#create-claimable-balance "Direct link to Create claimable balance")

Moves an amount of asset from the operation source account into a new ClaimableBalanceEntry

Learn more about claimable balances: [Claimable Balances Guide](/docs/build/guides/transactions/claimable-balances.md)
...
## Claim claimable balance[](#claim-claimable-balance "Direct link to Claim claimable balance")
...
Learn more about claimable balances and view more parameters: [Claimable Balances Guide](/docs/build/guides/transactions/claimable-balances.md)
...
| Parameters | Type | Description |
| --- | --- | --- |
| BalanceID | claimableBalanceID | BalanceID on the ClaimableBalanceEntry that the source account is claiming. The balanceID can be retrieved from a successful `CreateClaimableBalanceResult`. See [Claimable Balance Guide](/docs/build/guides/transactions/claimable-balances.md) for more information. |
...
## Begin sponsoring future reserves[](#begin-sponsoring-future-reserves "Direct link to Begin sponsoring future reserves")
...
Learn more about sponsored reserves: [Sponsored Reserves Guide](/docs/build/guides/transactions/sponsored-reserves.md)
...
## End sponsoring future reserves[](#end-sponsoring-future-reserves "Direct link to End sponsoring future reserves")
...
| Parameters | Type | Description |
| --- | --- | --- |
| begin\_sponsor | account ID | The id of the account which initiated the sponsorship. |
...
## Revoke sponsorship[](#revoke-sponsorship "Direct link to Revoke sponsorship")
...
| --- | --- | --- | --- |
| `REVOKE_SPONSORSHIP_LEDGER_ENTRY` | LedgerKey | ledgerKey | Ledger key that holds information to identify a specific ledgerEntry that may have its sponsorship modified. See [LedgerKey](/docs/learn/glossary.md) for more information. |
...
Learn more about clawbacks: [Clawback Guide](/docs/build/guides/transactions/clawbacks.md)
...
## Clawback claimable balance[](#clawback-claimable-balance "Direct link to Clawback claimable balance")
...
## Set trustline flags[](#set-trustline-flags "Direct link to Set trustline flags")
...
Learn more about flags: [Flags Glossary Entry](/docs/learn/glossary.md)
...
| `SET_TRUST_LINE_FLAGS_CANT_REVOKE` | -3 | The issuer is trying to revoke the trustline authorization of Trustor, but it cannot do so because AUTH\_REVOCABLE\_FLAG is not set on the account. |
| `SET_TRUST_LINE_FLAGS_INVALID_STATE` | -4 | If the final state of the trustline has both AUTHORIZED\_FLAG (1) and AUTHORIZED\_TO\_MAINTAIN\_LIABILITIES\_FLAG (2) set, which are mutually exclusive. |
...
## Liquidity pool deposit[](#liquidity-pool-deposit "Direct link to Liquidity pool deposit")
...
Learn more about liquidity pools: [Liquidity Pools section](/docs/learn/fundamentals/liquidity-on-stellar-sdex-liquidity-pools.md)
...
## Liquidity pool withdraw[](#liquidity-pool-withdraw "Direct link to Liquidity pool withdraw")
...
## Invoke Host Function[](#invoke-host-function "Direct link to Invoke Host Function")
...
Learn more [here](/docs/learn/fundamentals/contract-development/contract-interactions/stellar-transaction.md).
...
## Extend Footprint TTL[](#extend-footprint-ttl "Direct link to Extend Footprint TTL")
...
Learn more in the [State Archival section](/docs/learn/fundamentals/contract-development/storage/state-archival.md).
...
## Restore Footprint[](#restore-footprint "Direct link to Restore Footprint")
