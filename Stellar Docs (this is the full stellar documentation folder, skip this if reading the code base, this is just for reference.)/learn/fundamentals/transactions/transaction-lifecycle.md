...
### 1. Creation (Transaction Creator)[](#1-creation-transaction-creator "Direct link to 1. Creation (Transaction Creator)")
...
### 4. Propagating (Validator)[](#4-propagating-validator "Direct link to 4. Propagating (Validator)")
...
### 5. Crafting a candidate transaction set (Validator)[](#5-crafting-a-candidate-transaction-set-validator "Direct link to 5. Crafting a candidate transaction set (Validator)")
...
### 6. Nominating a transaction set (Validator)[](#6-nominating-a-transaction-set-validator "Direct link to 6. Nominating a transaction set (Validator)")

Once each validator has crafted a candidate transaction set, the set is nominated to the network.

### 7. Stellar Consensus Protocol (SCP) determines the final transaction set (Validator Network)[](#7-stellar-consensus-protocol-scp-determines-the-final-transaction-set-validator-network "Direct link to 7. Stellar Consensus Protocol (SCP) determines the final transaction set (Validator Network)")
...
### 8. Transaction apply order is determined (Validator Network)[](#8-transaction-apply-order-is-determined-validator-network "Direct link to 8. Transaction apply order is determined (Validator Network)")
...
### 9. Fees are collected (Validator)[](#9-fees-are-collected-validator "Direct link to 9. Fees are collected (Validator)")

Fees are collected for all transactions simultaneously.

### 10. Application (Validator)[](#10-application-validator "Direct link to 10. Application (Validator)")
...
### 11. Protocol Upgrades (Validator)[](#11-protocol-upgrades-validator "Direct link to 11. Protocol Upgrades (Validator)")
