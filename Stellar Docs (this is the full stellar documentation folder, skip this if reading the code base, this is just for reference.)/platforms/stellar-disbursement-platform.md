...
In this section, you'll find an [Admin Guide](/docs/platforms/stellar-disbursement-platform/admin-guide.md) that will teach you how to run the Stellar Disbursement Platform as well as an [API Reference](/docs/platforms/stellar-disbursement-platform/api-reference/admin.md).