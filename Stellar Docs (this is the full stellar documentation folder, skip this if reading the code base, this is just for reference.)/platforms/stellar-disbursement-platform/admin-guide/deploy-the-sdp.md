...
## Deployment via Helm Charts[](#deployment-via-helm-charts "Direct link to Deployment via Helm Charts")
...
### Installing the Chart[](#installing-the-chart "Direct link to Installing the Chart")

#### 1. Add the Stellar Helm Repository[](#1-add-the-stellar-helm-repository "Direct link to 1. Add the Stellar Helm Repository")
...
#### 2. Prepare Configuration[](#2-prepare-configuration "Direct link to 2. Prepare Configuration")
...
> **Tip:** There is a more detailed explanation of how to configure the SDP in the [Configuration Guide](/docs/platforms/stellar-disbursement-platform/admin-guide/configuring-sdp.md).

#### 3. Install the Chart[](#3-install-the-chart "Direct link to 3. Install the Chart")
...
## Deployment via Docker Compose[](#deployment-via-docker-compose "Direct link to Deployment via Docker Compose")
...
### Minimum System Requirements[](#minimum-system-requirements-1 "Direct link to Minimum System Requirements")
...
#### 2. Create Environment File[](#2-create-environment-file "Direct link to 2. Create Environment File")
...
#### 4. Start the Services[](#4-start-the-services "Direct link to 4. Start the Services")
