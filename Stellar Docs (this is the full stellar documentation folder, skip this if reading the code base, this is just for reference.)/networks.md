...
## Network Comparison[](#network-comparison "Direct link to Network Comparison")
...
| **Network ID** | `7ac33997544e3175d266bd022439b22cdb16508c01163f26e5cb2a3e1045a979` | `cee0302d59844d32bdca915c8203dd44b33fbb7edc19051ea37abedf28ecd472` | `a3a1c6a78286713e29be0e9785670fa838d13917cd8eaeb4a3579ff1debc7fd5` |
...
| **Horizon API** | [Multiple providers available](/docs/data/apis/horizon/providers.md) | <https://horizon-testnet.stellar.org> | <https://horizon-futurenet.stellar.org> |
| **Stellar RPC** | [Third-party providers only](/docs/data/apis/rpc/providers.md) | `https://soroban-testnet.stellar.org` | `https://rpc-futurenet.stellar.org` |
...
\*The precise amount can vary based on [resource limits](/docs/learn/fundamentals/fees-resource-limits-metering.md). See [Fees and Metering](/docs/learn/fundamentals/fees-resource-limits-metering.md) for detailed smart contract network settings.

## Friendbot[](#friendbot "Direct link to Friendbot")

Friendbot is a bot that funds accounts and contracts with fake XLM on Testnet or Futurenet. You can request XLM from Friendbot using the [Stellar Lab](/docs/tools/lab/account.md) or with various SDKs.
...
Check out [this How-To Guide](/docs/build/guides/basics/automate-reset-data.md) on automating Testnet and Futurenet reset data.
...
## Network IDs[](#network-ids "Direct link to Network IDs")
