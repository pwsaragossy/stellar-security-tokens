...
> **Info:** The values below are for reference. For current resource limits and fees on the live network, see Stellar Lab's [Network Limits](https://lab.stellar.org/network-limits) page.

## Resource Limits[](#resource-limits "Direct link to Resource Limits")

> **Note:** Resource limitations and fees only apply to smart contract transactions. Read more about the inner workings of fees on Stellar in the [Fees section](/docs/learn/fundamentals/fees-resource-limits-metering.md).

### Per-transaction limits[](#per-transaction-limits "Direct link to Per-transaction limits")
...
### TTL extension parameters[](#ttl-extension-parameters "Direct link to TTL extension parameters")
...
### Ledger-wide limits[](#ledger-wide-limits "Direct link to Ledger-wide limits")
