    ...
    return (
        <div className="max-w-4xl mx-auto space-y-8 py-8 px-4">
            ...
            <div className="space-y-4">
                ...
                <div>
                    <h1 className="text-3xl font-bold text-white">Understanding IPFS Document Storage</h1>
                ...
                <Card className="glass-panel border-white/10">
                    <CardContent className="pt-6">
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                <h3 className="font-semibold text-white mb-2">Immutability</h3>
                ...
                <Card className="glass-panel border-white/10">
                    <CardContent className="pt-6">
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                <h3 className="font-semibold text-white mb-2">Decentralization</h3>
                                <p className="text-sm text-white/70">
                ...
                <Card className="glass-panel border-white/10">
                    <CardContent className="pt-6">
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                <h3 className="font-semibold text-white mb-2">Permanence</h3>
                                <p className="text-sm text-white/70">
            ...
            <Card className="glass-panel border-white/10">
                <CardHeader>
                    <CardTitle>How Document Storage Works</CardTitle>
                </CardHeader>
                <CardContent>
                    <div className="space-y-4">
